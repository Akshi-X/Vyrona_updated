...
export default function AdvancedEmbryoGradingPage() {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[440px_minmax(0,1fr)_460px] xl:grid-rows-1 gap-4 min-h-0 flex-1">
            ...
            {step === 3 && (<>
              ...
              <div className="rounded-xl overflow-hidden shrink-0" style={{ height: '205.45px', background: 'var(--gradient-primary)' }}>
                <div className="px-4 pt-4 pb-3">
                  ...
                  <p className="text-6xl font-extrabold text-white leading-none tracking-tight">{mockAI.grade}</p>
                </div>
                <div className="px-4 pb-4" style={{ background: 'rgba(0,0,0,0.15)' }}>
                  <div className="pt-3">
                    <div className="flex items-center justify-between mb-1.5">
                      <span className="text-xs text-white/70">Confidence Score</span>
                      <span className="text-sm font-bold text-white">{mockAI.confidence}%</span>
                    </div>
                    <div className="h-2 rounded-full overflow-hidden" style={{ background: 'rgba(255,255,255,0.15)' }}>
                    ...
                    <div className="mt-3 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full" style={{ background: 'rgba(255,255,255,0.15)' }}>
                      ...
                      <span className="text-[11px] font-semibold text-white/90">{mockAI.quality}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {step === 4 && (<>
              ...
              <div className="rounded-xl overflow-hidden shrink-0" style={{ background: 'var(--gradient-primary)' }}>
                <div className="px-4 pt-4 pb-4 grid grid-cols-[1fr_auto_1fr] items-center gap-4">
                  {/* Left — AI Suggestion */}
                  <div>
                    <p className="text-[10px] font-semibold tracking-widest text-white/50 uppercase mb-1">AI Suggestion</p>
                  ...
                  <div className="text-right">
                    <p className="text-[10px] font-semibold tracking-widest text-white/50 uppercase mb-1">Override</p>
                    <p className="text-5xl font-extrabold text-white leading-none tracking-tight">
              ...
              <div className="rounded-lg border border-[#E7E1E1] bg-white p-4 flex flex-col gap-4">
                ...
                <div>
                  <p className="text-xs font-semibold text-gray-700 mb-1.5">Override Reason</p>
                  <textarea
      ...
      <div className="flex items-center justify-between px-6 py-3 border-t border-[#E7E1E1] bg-white mt-4 shrink-0 -mx-6 -mb-6">
        ...
        {step === 2 && (
          <p className="text-sm text-gray-400 mx-auto">Analyzing — please wait...</p>
        )}
        {step === 3 && (
          <>
    ...
    <div className={`rounded-xl border bg-white overflow-hidden flex flex-col min-h-0 ${locked ? 'border-[#E7E1E1] opacity-60 pointer-events-none' : 'border-[#E7E1E1]'}`}>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-10 text-center px-4">
          <p className="text-xs font-medium text-gray-400">No oocytes logged</p>
          <p className="text-[10px] text-gray-300 mt-0.5">Add entries on the Log Sheet tab</p>
        </div>
      ) : (
          ...
          {logs.map((log, idx) => {
            ...
            return (
              ...
              >
                ...
                {grade ? (
                  <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full border shrink-0 ${chipCls(grade)}`}>
                    {grade}
                  </span>
                ) : (
                  <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-amber-50 border border-amber-200 text-amber-600 shrink-0">
                    Ungraded
                  </span>
                )}
              </button>

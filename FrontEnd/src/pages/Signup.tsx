...
const Signup: React.FC = () => {
  ...
  return (
    <div
      className="bg-white w-full min-h-screen flex overflow-hidden"
      style={{ fontFamily: "'Work Sans', sans-serif" }}
    >
      {/* Left Section */}
      <aside
        className="w-[35%] flex flex-col justify-between text-white relative overflow-hidden h-screen"
        style={{
      ...
      >
        <div className="flex h-[15%] items-center space-x-2 p-12 pb-0">
          <img
            src={MyGrapeLogo}
            style={{ width: "41.87px", height: "55px" }}
            alt="logo"
          />
          ...
          <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative w-full">
                <input
                  ...
                  className={`peer w-full border rounded-[10px] px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#8b2a96] ${
            ...
            <div className="relative w-full">
              <select
                ...
                className={`peer w-full border rounded-[10px] px-3 py-2 pr-10 appearance-none focus:outline-none focus:ring-2 focus:ring-[#8b2a96] ${
                  designationError ? "border-red-500" : "border-gray-300"
            ...
            <div className="relative w-full">
              <input
                ...
                className={`peer w-full border rounded-[10px] px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#8b2a96] ${
                  organizationError ? "border-red-500" : "border-gray-300"
                }`}
              />
              {organizationError && (
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative w-full">
                <input
                  ...
                  className={`peer w-full border rounded-[10px] px-3 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-[#8b2a96] ${
                ...
                >
                  <img src={EyeOffIcon} className="w-5 h-5" style={{margin:"10px 0px"}} />
                </button>
                {passwordError && (
                ...
                <p
                  className={`text-[10px] mt-1 ${
                    passwordError ? "text-red-500" : "text-[#9a9a9a]"
                  }`}
                >

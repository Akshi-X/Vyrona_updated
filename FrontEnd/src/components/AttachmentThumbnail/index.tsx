...
const AttachmentThumbnail: React.FC<AttachmentThumbnailProps> = ({
  ...
  useEffect(() => {
    ...
    } else if (attachmentPath && isImageFile(filename)) {
  ...
  return (
    <div className={`relative bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden ${className}`}>

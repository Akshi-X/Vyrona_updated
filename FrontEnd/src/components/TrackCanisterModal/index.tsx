  ...
  const formContent = (
    ...
    return (
        <Modal
            ...
            icon={
                <img src={icon} alt="Track Canister" className="w-6 h-6 mt-5" />
            }

...
export default function RefrigeratorTrackingPageHospital8() {
  ...
  return (
    <>
    <PageLayout title="Refrigerator Tracking" description="Monitor temperature, alerts and tasks for IVF storage units" lucideIcon={Snowflake} actions={pageActions} patternBackground>

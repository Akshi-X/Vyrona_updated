"""
Custom exceptions for Patient operations
"""
...
class PatientAlreadyExistsError(PatientException):
    """Raised when trying to create a patient that already exists"""
    def __init__(self, patient_name: str = None):
        message = "Patient already exists"
        if patient_name:
            message = f"Patient with name '{patient_name}' already exists"
        super().__init__(message, "PATIENT_ALREADY_EXISTS")

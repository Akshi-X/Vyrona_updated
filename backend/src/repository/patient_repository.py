...
from ..utils.patient_utils import generate_patient_id
...
class PatientRepository:
    ...
    def create_patient(self, patient_data: PatientCreate) -> Patient:
        """Create a new patient record with custom ID format PT-ddmmyy001"""
        # Generate custom patient ID in format PT-ddmmyy001

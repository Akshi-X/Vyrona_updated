...
class ConnectionManager:
    ...
    async def broadcast(self, data: dict, db):
        ...
        Handles both CGT (patient_id) and IVF (tank_id/tank_code) messages.
        """
        ...
        # Handle IVF messages (tank_id or tank_code)
        tank_code = data.get("tank_code")
        tank_id_from_data = data.get("tank_id")
        
        if tank_id_from_data or tank_code:
            # Resolve to tank_id and tank_code
            if tank_code and not tank_id_from_data:

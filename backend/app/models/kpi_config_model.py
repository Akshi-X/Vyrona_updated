...
"""
from sqlalchemy import Column, Integer, String, Numeric, Boolean, Index, ForeignKey
...
class KpiConfig(Base):
    ...
    kpi_name = Column(String(255), nullable=False, comment="e.g. temp_external, ln2_level, evaporation_rate, lid_status, shock")
    alert_name = Column(String(255), nullable=True, comment="Null = value config for readings; 'l1'/'l2'/'critical' = threshold for ln2_level")
